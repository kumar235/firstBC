...
class Blockchain {
	...
	createGenesisBlock(){
		return new Block("24/04/18", "Genesis Block", "0");
	}
	...
	//method called by each miners
	//Skipping all validations for now. 
...
console.log('\n \n Latest block = \n ', myCoin.getLatestBlock());
console.log('\n \n End of First Mining balance of miner is ', myCoin.getBalanceOfAddress("minerAddress"));
...
console.log('\n \n Latest block = \n ', myCoin.getLatestBlock());
console.log('\n \n End of second Mining balance of miner is ', myCoin.getBalanceOfAddress("minerAddress"));

console.log('\n \n ************************ Starting THIRD BLOCK mining ************************ \n \n ');

myCoin.createTransactions(new Transaction("address-8", "address-3", 40 ));
myCoin.createTransactions(new Transaction("address-9", "address-5", 90 ));

myCoin.minePendingTransactions("minerAddress");

console.log('\n \n Latest block = \n ', myCoin.getLatestBlock());
console.log('\n \n End of third Mining balance of miner is ', myCoin.getBalanceOfAddress("minerAddress"));
//console.log('\n \n ======== Final balance of miner is ', myCoin.getBalanceOfAddress("minerAddress"));
